...
const processPayment = async () => {
  ...
  return (
    <div className="p-4 lg:p-6">
      {/* Outer container */}
      <div className="bg-white shadow-xl rounded-2xl p-4 lg:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left side: Products */}
        <div className="lg:col-span-2 flex flex-col">
          ...
          <div className="flex-1">
            {isSearching ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4 max-h-[28rem] overflow-y-auto pr-2">
